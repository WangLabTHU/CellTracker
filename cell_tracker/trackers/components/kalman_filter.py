...
class KalmanFilter():
    ...
    def initiate(self, measurement):
        ...
        Parameters
        ----------
        measurement : ndarray Bounding box coordinates (x_min, y_min, x_max, y_max)
    ...
    def update(self, mean, covariance, measurement):
        ...
        covariance : ndarray
          The state's covariance matrix (8x8 dimensional).
        measurement : ndarray
          The 4 dimensional measurement vector: Bounding box coordinates (x_min, y_min, x_max, y_max)
